...
namespace PatientsMedicines.Migrations
{
    ...
    [Migration("20240102154944_SeedDataAndGroupChanges")]
    partial class SeedDataAndGroupChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PatientsMedicines.DataLayer.Medicine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExpiryDate = new DateOnly(2024, 1, 2),
                            Name = "Pfumoflux",
            ...
            modelBuilder.Entity("PatientsMedicines.DataLayer.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 45,
                            BMI = 27m,
                            BirthDate = new DateOnly(1979, 1, 2),
                            FirstName = "Jan",
                            Gender = 1,
                            Height = 175m,
                            LastName = "Kowalski",
                        ...
                        new
                        {
                            ...
                            Age = 47,
                            BMI = 30m,
                            BirthDate = new DateOnly(1977, 1, 2),
                            FirstName = "Janina",
                            Gender = 0,
                            Height = 155m,
                            LastName = "Kowalska",
